...
return [
    ...
    // Top bar
    'top_delivery' => 'Доставка и оплата',
    'top_guarantee' => 'Гарантия и возврат',
    'top_career' => 'Карьера',
    'top_faq' => 'FAQ',
    ...
    // Footer column links
    'footer_cat_engine' => 'Двигатель',
    'footer_cat_brakes' => 'Тормозная система',
    'footer_cat_filters' => 'Фильтры',
    'footer_cat_suspension' => 'Подвеска',
    'footer_cat_electric' => 'Электрика',
    'footer_cat_accessories' => 'Аксессуары',

    'footer_buy_delivery' => 'Доставка и оплата',
    'footer_buy_guarantee' => 'Гарантия и возврат',
    'footer_buy_loyalty' => 'Программа лояльности',

    'footer_com_about' => 'О компании',
    ...
    'article_subtitle' => 'Новый этап развития экосистемы Bronber',
    'article_lead' => 'Bronber объявляет о запуске нового направления — Bronber Auto Service. Это логичный этап развития экосистемы бренда, объединяющий торговлю автозапчастями и профессиональный автосервис в единую систему обслуживания.',
    'article_heading' => 'Профессиональный подход',
    'article_body_1' => 'Bronber Auto Service — это профессиональный автосервис, созданный с учетом стандартов качества, обслуживания и опыта. Современное оборудование, квалифицированные специалисты и широкий спектр услуг для вашего автомобиля.',
    'article_body_2' => 'Открытие нового направления позволяет нам предложить клиентам полный цикл услуг — от подбора и продажи запчастей до профессиональной установки и диагностики. Все работы выполняются с использованием оригинальных деталей и сертифицированных материалов.',
    'article_cta' => 'Перейти к направлению',
    'article_related_title' => 'Другие новости',

    // 404 page
    'error_404_title' => 'Страница не найдена',
    'error_404_desc' => 'К сожалению, запрашиваемой страницы не существует или была перемещена.<br>Проверьте адрес или перейдите на главную страницу.',
    'error_404_home_btn' => 'На главную',
    'error_404_catalog_btn' => 'Перейти в каталог',

    // Favorites page
    'favorites_title' => 'Избранное',
    'favorites_count' => '43 товара в избранном',

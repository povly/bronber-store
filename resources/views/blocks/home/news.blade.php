    ...
    <div class="container">
        <div class="home-news__header section__top">
            ...
            <div class="home-news__arrows home-news__arrows--top slider__arrows">
                <button class="slider__arrow slider__arrow--prev home-news__arrow home-news__arrow--prev" type="button"
                ...
                <button class="slider__arrow slider__arrow--next home-news__arrow home-news__arrow--next" type="button"
        ...
        <div class="home-news__slider slider">
            <div class="home-news__track slider__track" x-ref="track" @pointerdown.prevent="onPointerDown($event)"
                ...
                @foreach ($news as $item)
                    <article class="home-news__slide slider__slide">
                        <a href="#" class="article">
                            <img data-src="{{ $item['image'] }}" alt="{{ $item['title'] }}" class="article__image lazy"

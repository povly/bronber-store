...
<section class="home-advs section" x-data="slider({ pagination: true, breakpoints: { 0: { perView: 1 }, 768: { perView: 2 }, 1200: { perView: 4 } } })" @resize.window.debounce.150ms="onResize()">
    <div class="container">

...
<section class="home-partners section" x-data="slider({ grid: { breakpoints: { 0: { cols: 2, rows: 4 }, 768: { cols: 5, rows: 2 } } }, pagination: true })" @resize.window.debounce.150ms="onResize()">
    <div class="container">
        <div class="home-partners__header section__top">
            ...
            <div class="home-partners__arrows home-partners__arrows--pc slider__arrows--pc slider__arrows">
                <button class="slider__arrow slider__arrow--prev home-partners__arrow home-partners__arrow--prev" type="button" aria-label="Назад" @click="prev()" :disabled="!canPrev">
                ...
                <button class="slider__arrow slider__arrow--next home-partners__arrow home-partners__arrow--next" type="button" aria-label="Вперёд" @click="next()" :disabled="!canNext">
                    <svg width="22" height="12" viewBox="0 0 22 12" fill="none" xmlns="http://www.w3.org/2000/svg">

...
<section class="home-products section" x-data="slider({ breakpoints: { 0: { grid: { cols: 2, rows: 2 } }, 1200: { perView: 4 } } })" @resize.window.debounce.150ms="onResize()">
    <div class="container">
        <div class="section__top home-products__header">
            ...
            <div class="home-products__nav">
                <div class="home-products__arrows home-products__arrows--pc slider__arrows--pc slider__arrows">
                    <button class="slider__arrow slider__arrow--prev home-products__arrow home-products__arrow--prev"
                        type="button" aria-label="Назад" @click="prev()" :disabled="!canPrev">
                    ...
                    <button class="slider__arrow slider__arrow--next home-products__arrow home-products__arrow--next"
                        type="button" aria-label="Вперёд" @click="next()" :disabled="!canNext">
                        <svg width="22" height="12" viewBox="0 0 22 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="home-products__slider slider">
            <div class="home-products__track slider__track" x-ref="track" @pointerdown.prevent="onPointerDown($event)"

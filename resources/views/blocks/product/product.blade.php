...
<section class="product" x-data="product()">
        ...
        <div class="container">
            ...
            <div class="product__hero-grid">
                ...
                <div class="product__gallery" x-data="{ active: 0 }">
                    <x-slider
                        :config="['freeMode' => true,'breakpoints' => [0 => ['perView' => 4], 1200 => ['perView' => 4, 'vertical' => true]]]"
                    ...
                    <x-slider
                        :config="['freeMode' => true,'perView' => 1, 'pagination' => true]"
    ...
    <div class="container">
        <x-slider
            :config="['loop' => true, 'freeMode' => true, 'breakpoints' => [0 => ['perView' => 1, 'autoHeight' => true], 1200 => ['perView' => 2]]]"
            ...
            @foreach ($product['reviews'] as $review)
                <article class="slider__slide product__review">
                    <div class="product__review-head">
                        ...
                        <p class="product__review-date product__review-date--pc">{{ $review['date'] }}</p>
                    </div>
                    <div class="product__review-block">
                        ...
                        <p class="product__review-date product__review-date--mb">{{ $review['date'] }}</p>
                    </div>

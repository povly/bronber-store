...
<header class="header" x-data="storeHeader(@js($searchTypes))">
    <div class="header__top container">
        <a href="/" class="header__logo" aria-label="bronber — На главную">
        ...
        <div class="header__search">
            ...
            <input
                ...
                name="search"
            >
            <button type="button" class="header__search-btn" aria-label="Искать">
        ...
        <div class="header__actions">
            <a href="#" class="header__action header__action--search" aria-label="Поиск">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <circle cx="11" cy="11" r="7" stroke="currentColor" stroke-width="2"/>
                    <path d="M16.5 16.5L21 21" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                </svg>
            </a>
            <a href="#" class="header__action header__action--user" aria-label="Профиль">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <a href="#" class="header__action header__action--favorites" aria-label="Избранное">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <a href="#" class="header__action header__action--cart" aria-label="Корзина">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    <nav class="header__nav">
        <div class="header__nav-inner container">
            <button type="button" class="header__catalog-btn" aria-label="Каталог товаров">
            ...
            <a href="#" class="header__nav-link header__nav-link--catalog">Каталог</a>
            <a href="#" class="header__nav-link">Новинки</a>
            <a href="#" class="header__nav-link">Акции</a>
            <a href="#" class="header__nav-link">Блог</a>
            <a href="#" class="header__nav-link">Бонусы</a>

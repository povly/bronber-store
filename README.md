...
на Blade + Alpine.js; контент ключевых страниц (главная, FAQ, доставка и оплата, возврат и обмен, программа лояльности, страница 404), шапка/подвал и мобильные меню уже управляются из
